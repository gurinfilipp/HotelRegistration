...
//  HotelManzana
//
//  Created by Philip on 19.03.2021.
//
...
class RegistrationTableViewController: UITableViewController {
    ...
    @IBSegueAction func showRegistration(_ coder: NSCoder, sender: Any?) -> AddRegistrationTableViewController? {
        ...
        print("ShowRegistrationFuncgo")
        let registration = registrations[indexPath.row]
        let addRegistrationTableViewController = AddRegistrationTableViewController(coder: coder)
        addRegistrationTableViewController?.exisitingRegistration = registration
...
//        // Тут про то, чтобы при нажатии на ячейку, открывался тейбл вью где можно менять данные
//    }
